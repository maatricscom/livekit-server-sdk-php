...
class Room extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>string metadata = 8 [(.logger.redact_format) = "<redacted ({{ .Size }} bytes)>", (.logger.sensitivity) = SENSITIVITY_PII];</code>
     */
    protected $metadata = '';
    /**
     ...
     *     @type array<\LiveKit\Proto\Codec>|\Google\Protobuf\Internal\RepeatedField $enabled_codecs
    ...
    /**
     * Generated from protobuf field <code>.livekit.TimedVersion version = 13;</code>
     * @return \LiveKit\Proto\TimedVersion|null
     */
