...
class AddTrackRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type array<\LiveKit\Proto\SimulcastCodec>|\Google\Protobuf\Internal\RepeatedField $simulcast_codecs
     *     @type string $sid
     *           server ID of track, publish new codec to exist track
     *     @type bool $stereo
     *           deprecated in favor of audio_features
    ...
    /**
     * Generated from protobuf field <code>repeated .livekit.SimulcastCodec simulcast_codecs = 10;</code>
     * @param array<\LiveKit\Proto\SimulcastCodec>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSimulcastCodecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \LiveKit\Proto\SimulcastCodec::class);
