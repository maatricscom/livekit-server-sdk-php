...
class CreateSIPParticipantRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string to_user_override = 27;</code>
     */
    protected $to_user_override = '';
    /**
     ...
     *           What SIP Trunk should be used to dial the user
     *     @type \LiveKit\Proto\SIPOutboundConfig $trunk
     *     @type \LiveKit\Proto\SIPRequestDest $sip_request_uri
     *           INVITE <uri>
     *     @type \LiveKit\Proto\SIPNamedDest $sip_to_header
     *           Currently not usable with CreateSIPParticipant: sip_call_to is required, and
     *           the two cannot be combined. Use to_user_override to change the To header user.
     *     @type \LiveKit\Proto\SIPNamedDest $sip_from_header
     *           From: "Name" <uri>
     *     @type string $sip_call_to
     *           What number should be dialed via SIP
     *     @type string $to_user_override
     *           Replaces the user part of the To header, leaving its host, port and transport
     *           as they would otherwise be. The request URI is not affected, so the call is
     *           still placed to sip_call_to. Empty means no override.
     *           Use this when the callee expects a To header that differs from the number
     ...
     *           2) Empty string: Do not send a display name, which will result in a CNAM lookup downstream.
     *           3) Non-empty: Use the specified value as the display name.
     *     @type \LiveKit\Proto\Destination $destination
     *           NEXT ID: 28
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.livekit.SIPOutboundConfig trunk = 20;</code>
     * @return \LiveKit\Proto\SIPOutboundConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.livekit.SIPRequestDest sip_request_uri = 24;</code>
     * @return \LiveKit\Proto\SIPRequestDest|null
     */
     ...
     *
     * Generated from protobuf field <code>.livekit.SIPNamedDest sip_to_header = 25;</code>
     * @return \LiveKit\Proto\SIPNamedDest|null
     */
     ...
     * @return string
     */
    public function getToUserOverride()
    {
        return $this->to_user_override;
    }
    ...
    /**
     * Generated from protobuf field <code>.livekit.SIPMediaConfig media = 23;</code>
     * @return \LiveKit\Proto\SIPMediaConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .livekit.Destination destination = 22;</code>
     * @return \LiveKit\Proto\Destination|null
     */
