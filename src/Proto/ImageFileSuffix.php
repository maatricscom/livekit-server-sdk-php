...
/**
 * Protobuf type <code>livekit.ImageFileSuffix</code>
 */
class ImageFileSuffix
{
    /**
     * Generated from protobuf enum <code>IMAGE_SUFFIX_INDEX = 0;</code>
     */
    const IMAGE_SUFFIX_INDEX = 0;
    /**
