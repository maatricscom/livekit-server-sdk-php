...
class TextHeader extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.livekit.DataStream.OperationType operation_type = 1;</code>
     * @return int one of the values in {@see \LiveKit\Proto\DataStream\OperationType}
     */
    ...
    /**
     * Generated from protobuf field <code>.livekit.DataStream.OperationType operation_type = 1;</code>
     * @param int $var one of the values in {@see \LiveKit\Proto\DataStream\OperationType}
     * @return $this
     */
    public function setOperationType(int $var)
    {
        GPBUtil::checkEnum($var, \LiveKit\Proto\DataStream\OperationType::class);
