...
class ClientInfo extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.livekit.ClientInfo.SDK sdk = 1;</code>
     * @return int one of the values in {@see \LiveKit\Proto\ClientInfo\SDK}
     */
    ...
    /**
     * Generated from protobuf field <code>.livekit.ClientInfo.SDK sdk = 1;</code>
     * @param int $var one of the values in {@see \LiveKit\Proto\ClientInfo\SDK}
     * @return $this
     */
    public function setSdk(int $var)
    {
        GPBUtil::checkEnum($var, \LiveKit\Proto\ClientInfo\SDK::class);
        $this->sdk = $var;
