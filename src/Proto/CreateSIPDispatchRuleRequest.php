...
class CreateSIPDispatchRuleRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string metadata = 5 [deprecated = true, (.logger.redact_format) = "<redacted ({{ .Size }} bytes)>", (.logger.sensitivity) = SENSITIVITY_PII];</code>
     * @deprecated
     */
    protected $metadata = '';
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, string> attributes = 7 [deprecated = true, (.logger.redact_format) = "<redacted ({{ .Size }} bytes)>", (.logger.sensitivity) = SENSITIVITY_PII];</code>
     * @deprecated
     */
    private $attributes;
    /**
     ...
     *           Cloud-only, config preset to use
     *     @type \LiveKit\Proto\RoomConfiguration $room_config
     *           RoomConfiguration to use if the participant initiates the room
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.livekit.SIPDispatchRule rule = 1 [deprecated = true];</code>
     * @return \LiveKit\Proto\SIPDispatchRule|null
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>.livekit.RoomConfiguration room_config = 9 [deprecated = true];</code>
     * @return \LiveKit\Proto\RoomConfiguration|null
     * @deprecated
     */
