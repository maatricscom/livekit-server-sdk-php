...
- `src/Proto/` and `metadata/` are excluded from Pint, and `src/Proto/` from PHPStan. Anything you put
  there stops being checked. That exclusion is right for generated output and wrong for everything else.
